...
static const flex_int16_t yy_base[78] =
    {   0,
        0,    0,   28,   29,  129,  162,   31,   34,  108,   35,
       46,    0,   33,  162,  107,  112,   32,   32,   36,  107,
       24,   93,  102,    0,   94,  162,  162,  105,   52,    0,
        0,   52,  162,  115,   48,    0,   57,   51,  162,  114,
        0,  162,    0,   78,   50,   59,   78,  162,  162,  162,
        0,  162,    0,   87,  162,  162,    0,   84,    0,  104,
       68,   80,   70,  162,   94,   71,   88,  162,  134,   89,
...
static const flex_int16_t yy_nxt[193] =
    {   0,
       ...
       58,   58,   60,   61,   61,   60,   67,   67,   60,   60,
       65,   30,   60,   62,   62,   62,   62,   60,   64,   62,

       62,   62,   62,   67,   67,   66,   66,   60,   60,   67,
       67,   60,   64,   55,   60,   60,   68,   68,   60,   56,
       55,   52,   51,   60,   48,   42,   41,   31,   68,   68,
...
static const flex_int16_t yy_chk[193] =
    {   0,
       ...
       37,   37,   44,   61,   61,   44,   66,   66,   44,   44,
       61,   70,   44,   47,   47,   62,   62,   44,   63,   47,

       47,   62,   62,   67,   67,   65,   65,   44,   60,   65,
       65,   60,   58,   54,   60,   60,   40,   34,   60,   28,
       25,   23,   22,   60,   20,   16,   15,    9,    5,    0,
        0,    0,    0,   60,   69,   69,   69,   69,   69,   71,
...
#line 527 "build/parser/cypher_scanner.c"
...
#line 544 "build/parser/cypher_scanner.c"
...
#define YY_EXTRA_TYPE CypherScannerState *
...
YY_DECL
{
	...
	{
#line 101 "src/backend/parser/cypher_scanner.l"


#line 804 "build/parser/cypher_scanner.c"
...
case 2:
YY_RULE_SETUP
#line 115 "src/backend/parser/cypher_scanner.l"
{
                    /* Skip line comments */
                    continue;
                }
...
case 3:
YY_RULE_SETUP
#line 120 "src/backend/parser/cypher_scanner.l"
{
...
case 4:
YY_RULE_SETUP
#line 125 "src/backend/parser/cypher_scanner.l"
{
...
YY_RULE_SETUP
#line 130 "src/backend/parser/cypher_scanner.l"
{
...
case 6:
YY_RULE_SETUP
#line 136 "src/backend/parser/cypher_scanner.l"
{
...
case 7:
YY_RULE_SETUP
#line 140 "src/backend/parser/cypher_scanner.l"
{ RETURN_TOKEN(CYPHER_TOKEN_NOT_EQ); }
	YY_BREAK
case 8:
YY_RULE_SETUP
#line 141 "src/backend/parser/cypher_scanner.l"
...
{ prepare_integer_token(yyextra, yytext); return CYPHER_TOKEN_INTEGER; }
	YY_BREAK
case 15:
YY_RULE_SETUP
#line 149 "src/backend/parser/cypher_scanner.l"
{ prepare_integer_token(yyextra, yytext); return CYPHER_TOKEN_INTEGER; }
	YY_BREAK
case 16:
YY_RULE_SETUP
#line 150 "src/backend/parser/cypher_scanner.l"
{ prepare_decimal_token(yyextra, yytext); return CYPHER_TOKEN_DECIMAL; }
	YY_BREAK
case 17:
...
YY_RULE_SETUP
#line 166 "src/backend/parser/cypher_scanner.l"
{
...
case 19:
YY_RULE_SETUP
#line 180 "src/backend/parser/cypher_scanner.l"
{
...
case 20:
YY_RULE_SETUP
#line 186 "src/backend/parser/cypher_scanner.l"
{
...
case 21:
YY_RULE_SETUP
#line 192 "src/backend/parser/cypher_scanner.l"
{
...
YY_RULE_SETUP
#line 206 "src/backend/parser/cypher_scanner.l"
{
...
case 23:
YY_RULE_SETUP
#line 223 "src/backend/parser/cypher_scanner.l"
{
...
case 24:
YY_RULE_SETUP
#line 238 "src/backend/parser/cypher_scanner.l"
{ prepare_string_token(yyextra, CYPHER_TOKEN_OPERATOR, yytext, yytext); return CYPHER_TOKEN_OPERATOR; }
	YY_BREAK
case 25:
YY_RULE_SETUP
...
case 26:
YY_RULE_SETUP
#line 241 "src/backend/parser/cypher_scanner.l"
{ prepare_token(yyextra, CYPHER_TOKEN_CHAR, yytext); return CYPHER_TOKEN_CHAR; }
	YY_BREAK
case YY_STATE_EOF(INITIAL):
case YY_STATE_EOF(BLOCK_COMMENT):
#line 243 "src/backend/parser/cypher_scanner.l"
{ prepare_token(yyextra, CYPHER_TOKEN_EOF, ""); return CYPHER_TOKEN_EOF; }
	YY_BREAK
case 27:
YY_RULE_SETUP
...
case 28:
YY_RULE_SETUP
#line 254 "src/backend/parser/cypher_scanner.l"
YY_FATAL_ERROR( "flex scanner jammed" );
	YY_BREAK
#line 1111 "build/parser/cypher_scanner.c"
...
static void prepare_integer_token(CypherScannerState *state, const char *text)
{
    ...
    if (text[0] == '0' && (text[1] == 'x' || text[1] == 'X')) {
        /* Hexadecimal */
        state->current_token.value.integer = strtoll(text, NULL, 16);
    } else if (text[0] == '0' && strlen(text) > 1) {
        /* Octal */
        state->current_token.value.integer = strtoll(text, NULL, 8);
    } else {
        /* Decimal */
        state->current_token.value.integer = strtoll(text, NULL, 10);
    }
}
